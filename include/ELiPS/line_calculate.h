...
//Pseudo 8-sparse
extern void fp2_mul_nor_montgomery(fp2_t *ANS, fp2_t *A);
extern void fp2_add_mpn_single(fp2_t *ANS, fp2_t *A, mp_limb_t *B);
...
extern void fp12_7_sparse_mul_lazy_montgomery(fp12_t *C, fp12_t *A, fp12_t *B);
...
extern void ff_ltt_projective_7sparse_lazy_montgomery(fp12_t *f, efp2_projective_t *T, efp_t *P);
