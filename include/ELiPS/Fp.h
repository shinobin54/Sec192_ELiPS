...
/**
 * @brief Multiplication a fp_t type struct and a fp_t type struct on prime field (Montgomery Reduciton)
 *
 * @param[out]ANS --a pointer of answer.
...
/**
 * @brief Multiplication a fp_t type struct and a fp_t type struct on prime field (Always mod)
 *
 * @param[out]ANS --a pointer of answer.
 * @param[in]A --a pointer in fp_t.
 * @param[in]B --a pointer in fp_t.
 */
extern void fp_mul_final(fp_t *ANS,fp_t *A,fp_t *B);
...
/**
 * @brief Addition a fp_t type struct and a fp_t type struct on prime field (Always mod)
 *
 * @param[out]ANS --a pointer of answer.
 * @param[in]A --a pointer in fp_t.
 * @param[in]B --a pointer in fp_t.
 */
extern void fp_add_final(fp_t *ANS,fp_t *A,fp_t *B);
 ...
 * @param[in]B --a pointer in mpn.
 */
extern void fp_sub_lazy_mod(fp_t *ANS,mp_limb_t *A,mp_limb_t *B);

/**
 * @brief Subtraction a fp_t type struct and a fp_t type struct on prime field (Always mod)
 *
 * @param[out]ANS --a pointer of answer.
 * @param[in]A --a pointer in fp_t.
 * @param[in]B --a pointer in fp_t.
 */
extern void fp_sub_final(fp_t *ANS,fp_t *A,fp_t *B);
...
//extern void fp_inv_monty(fp_t *ANS,fp_t *a);
#endif
