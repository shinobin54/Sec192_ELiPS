...
int bls12_test_rational_point()
{
    ...
    if (test_g1.infinity != 1 || test_g2.infinity != 1)
        return 1;
    else
        return 0;
}
...
{
    int i, n = 0;
    float opt_time = 0, opt_compress_time = 0, opt_compress_lazy_time = 0, opt_projective_compress_lazy_time = 0, opt_lazy_time = 0, opt_compress_lazy_montgomery_time = 0, opt_projective_compress_lazy_montgomery_time = 0, opt_projective_7sparse_compress_lazy_montgomery_time = 0;
    cost tmp, opt_cost, opt_compress_cost, opt_compress_lazy_cost, opt_projective_compress_lazy_cost, opt_lazy_cost, opt_compress_lazy_montgomery_cost, opt_projective_compress_lazy_montgomery_cost, opt_projective_7sparse_compress_lazy_montgomery_cost;
    ...
    fp12_t Z, testA, testB, testC, test1, test2, test3, test4, test5, test6, test7, test8;
    fp12_init(&Z);
    fp12_init(&testA);
    fp12_init(&testB);
    fp12_init(&testC);
    ...
    cost_init(&opt_projective_7sparse_compress_lazy_montgomery_cost);
    ...
    cost_init(&MILLER_OPT_PROJECTIVE_7SPARSE_MONTGOMERY_COST);
    cost_init(&FINALEXP_OPT_PROJECTIVE_7SPARSE_MONTGOMERY_COST);
    bls12_generate_g2(&Q);
    for (i = 0; i < pairing; i++)
    {
        ...
        cost_zero();
        gettimeofday(&tv_A, NULL);
        bls12_optate_pairing_projective_7sparse_compress_lazy_montgomery(&test8, &P, &Q);
        gettimeofday(&tv_B, NULL);
        opt_projective_7sparse_compress_lazy_montgomery_time += timedifference_msec(tv_A, tv_B);
        cost_check(&tmp);
        cost_addition(&opt_projective_7sparse_compress_lazy_montgomery_cost, &tmp);
    ...
    cost_substruction(&FINALEXP_OPT_PROJECTIVE_7SPARSE_MONTGOMERY_COST, &opt_projective_7sparse_compress_lazy_montgomery_cost, &MILLER_OPT_PROJECTIVE_7SPARSE_MONTGOMERY_COST);
    ...
    printf("bls12 opt ate projective 7sparse compress lazy montgomery.         : %.4f[ms]\n", opt_projective_7sparse_compress_lazy_montgomery_time / pairing);
    printf("bls12 opt ate projective 7sparse compress lazy(MILLER_OPTATE_MONT).: %.4f[ms]\n", MILLER_OPT_PROJECTIVE_7SPARSE_MONTGOMERY / pairing);
    printf("bls12 opt ate projective 7sparse compress lazy(FINALEXP_OPT_MONT). : %.4f[ms]\n", FINALEXP_OPT_PROJECTIVE_7SPARSE_MONTGOMERY / pairing);
    ...
    cost_printf("bls12 opt ate projective 7sparse  compress lazy montgomery", &opt_projective_7sparse_compress_lazy_montgomery_cost, pairing);
    cost_printf("bls12 opt ate projective 7sparse  compress lazy(MILLER_OPT_MONT)", &MILLER_OPT_PROJECTIVE_7SPARSE_MONTGOMERY_COST, pairing);
    cost_printf("bls12 opt ate projective 7sparse  compress lazy(FINALEXP_OPT_MONT)", &FINALEXP_OPT_PROJECTIVE_7SPARSE_MONTGOMERY_COST, pairing);
    printf("***************************************         \n");
#endif
