...
/*mine*/
void BLS12_Plain_ate_projective_plain(Fp12 *ANS,EFp12 *P,EFp12 *Q){
    //Miller's Algo.
    Miller_opt_projective_plain(ANS,P,Q);

    //Final Exp.
    BLS12_Final_exp_plain(ANS,ANS);
}
void BLS12_Plain_ate_projective_projective(Fp12 *ANS,EFp12 *P,EFp12 *Q){
    //Miller's Algo.
    Miller_opt_projective_projective(ANS,P,Q);

    //Final Exp.
    BLS12_Final_exp_plain(ANS,ANS);
}
void BLS12_Plain_ate_debag(Fp12 *ANS,EFp12 *P,EFp12 *Q){
    //Miller's Algo.
    Miller_debag(ANS,P,Q);
