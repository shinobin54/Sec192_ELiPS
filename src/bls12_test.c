...
/*mine*/
int BLS12_test_opt_ate_pairing_debag(int pairing){
  int i,n=0;
  float opt_time=0,opt_compress_time=0,opt_compress_lazy_time=0,opt_lazy_time=0,opt_compress_lazy_montgomery_time=0;
  cost tmp,opt_cost,opt_compress_cost,opt_compress_lazy_cost,opt_lazy_cost,opt_compress_lazy_montgomery_cost;
  struct timeval tv_A,tv_B;
  ...
  BLS12_Plain_ate_debag(&Z,&P,&Q);
  Fp12_pow(&testA,&Z,s12);
  BLS12_Plain_ate_debag(&testB,&s1P,&s2Q);
  BLS12_Plain_ate_debag(&testC,&s2P,&s1Q);
  ...
  printf("bilinear success!!\n\n");
  return 0;
}
int BLS12_test_opt_ate_pairing_projective_projective(int pairing){
  int i,n=0;
  float opt_time=0,opt_compress_time=0,opt_compress_lazy_time=0,opt_lazy_time=0,opt_compress_lazy_montgomery_time=0;
  cost tmp,opt_cost,opt_compress_cost,opt_compress_lazy_cost,opt_lazy_cost,opt_compress_lazy_montgomery_cost;
  struct timeval tv_A,tv_B;
  ...
  BLS12_Plain_ate_projective_projective(&Z,&P,&Q);
  Fp12_pow(&testA,&Z,s12);
  BLS12_Plain_ate_projective_projective(&testB,&s1P,&s2Q);
  BLS12_Plain_ate_projective_projective(&testC,&s2P,&s1Q);
...
int BLS12_test_opt_ate_pairing_projective_plain(int pairing){
  int i,n=0;
  float opt_time=0,opt_compress_time=0,opt_compress_lazy_time=0,opt_lazy_time=0,opt_compress_lazy_montgomery_time=0;
  cost tmp,opt_cost,opt_compress_cost,opt_compress_lazy_cost,opt_lazy_cost,opt_compress_lazy_montgomery_cost;
  struct timeval tv_A,tv_B;
  ...
  BLS12_Plain_ate_projective_plain(&Z,&P,&Q);
  Fp12_pow(&testA,&Z,s12);
  BLS12_Plain_ate_projective_plain(&testB,&s1P,&s2Q);
  BLS12_Plain_ate_projective_plain(&testC,&s2P,&s1Q);
